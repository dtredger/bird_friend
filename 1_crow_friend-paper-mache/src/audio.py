...
# To solve  XDG_RUNTIME_DIR not set in the environment
if "XDG_RUNTIME_DIR" not in os.environ:
    os.environ["XDG_RUNTIME_DIR"] = "/tmp/runtime-root"

# to solve ALSA lib pcm.c:8526:(snd_pcm_recover) underrun occurred
mixer.pre_init(buffer=2048) #frequency=48000,
...
SOUND_FILE_ROOT = '/home/root/1_crow_friend (paper mache)/sounds/'
